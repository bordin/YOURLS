...
define( 'YOURLS_SITE', 'https://nstda.org/s' );
 ...
 ** Hint: copy from http://yourls.org/cookie */
 define( 'YOURLS_COOKIEKEY', 'BAgVmCn5S]gYQgsnPa2&cqD7d4vJc}EtXV4(Dvkv' );

/** Username(s) and password(s) allowed to access the site. Passwords either in plain text or as encrypted hashes
 ** YOURLS will auto encrypt plain text passwords in this file
 ** Read http://yourls.org/userpassword for more information */
$yourls_user_passwords = [
	'admin' => 'phpass:!2a!08!U.fNvVN1pLMakcKJ1rott.xOUIdUadRMdBH.Rpn7eGDgZnOuFJeU.' /* Password encrypted by YOURLS */  /* Password encrypted by YOURLS */ ,
	// 'username2' => 'password2',
